...
<head>
  ...
  <title>Basic Banking System: Alankrit Vyas</title>
  <style>
    * {
...
<body>
  <nav>
    <div class="container-fluid nav-wrapper  grey darken-3 z-depth-5">
      <a href="index.php" class="brand-logo"><img src="images/TSB.png" style="height:100px;width:100px" /></a>
        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="header-avzz pt-lg-5 pt-3 text-center mx-auto">
                <h3 class="tittle mb-lg-4 mb-3">The Sparks Bank</h3>
            </div>
          ...
          <div class="row mt-4">
            ...
            <div class="col-md-4 on-hover">
                <div class=" border-0 mb-4">
                  <img class="card-img-top" src="images/transaction.png">
            ...
            <div class="col-md-4 on-hover">
              <div class=" border-0 mb-4">
                <img class="card-img-top" src="images/TSB.png">                
            ...
            <div class="col-md-4 on-hover">
                <div class=" border-0 mb-4">
                  <img class="card-img-top" src="images/th.png">            
